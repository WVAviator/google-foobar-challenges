...
def solution(s):
    ...
    for i in range(len(s)):
        if (s[i] == "<"):
            salutes += rightFacingCount
        elif (s[i] == ">"):
            rightFacingCount += 1
        if (s[-i - 1] == ">"):
            salutes += leftFacingCount
        elif(s[-i - 1] == "<"):
            leftFacingCount += 1
    return salutes
...
equals("Test 1", 2, lambda: solution(">----<"))
equals("Test 2", 4, lambda: solution("<<>><"))
equals("Test 3", 0, lambda: solution("<<<>>>"))
equals("Test 3", 12, lambda: solution(">>----<----<<"))
equals("Test 3", 18, lambda: solution(">>>---<<<"))
